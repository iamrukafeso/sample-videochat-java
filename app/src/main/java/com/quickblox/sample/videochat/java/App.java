...
//    private static final String ACCOUNT_KEY = "";
    ...
    static final String APPLICATION_ID = "80834";
    static final String AUTH_KEY = "9L9qcfPYqSZhCmu";
    static final String AUTH_SECRET = "z-gDcESbC4nRQrY";
    static final String ACCOUNT_KEY = "fNVvzD84cEPCQAghdrKv";
